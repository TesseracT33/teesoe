...
inline constexpr bool enable_cpu_jit_error_handler = 0;
...
inline constexpr bool log_cpu_jit_register_status = enable_logging && 1;
...
inline constexpr bool log_rsp_instructions = enable_logging && 1;
inline constexpr bool log_rsp_jit_blocks = enable_logging && 1;
inline constexpr bool log_rsp_jit_register_status = enable_logging && 1;
