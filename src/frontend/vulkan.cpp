...
{ // TODO: possibly put this in ParallelRDPWrapper class instead
    ...
    { // Create Descriptor Pool
        static constexpr VkDescriptorPoolSize pool_sizes[] = { { VK_DESCRIPTOR_TYPE_SAMPLER, 1000 },
