...
__m128i _mm_mulhi_epu16_epi16(__m128i a, __m128i b)
{
    ...
    __m128i correction = _mm_mullo_epi16(a, _mm_srli_epi16(_mm_cmplt_epi16(b, _mm_setzero_si128()), 15));
...
{
    return _mm_sign_epi16(a, _mm_set1_epi64x(s64(-1)));
}
...
{
    return _mm_xor_si128(a, _mm_set1_epi64x(s64(-1)));
}
